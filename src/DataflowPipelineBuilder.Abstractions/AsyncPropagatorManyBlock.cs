...
/// <summary>
/// Abstract base class for creating custom propagator blocks with asynchronous one-to-many transform logic.
...
/// For synchronous transforms, use <see cref="PropagatorManyBlock{TInput, TOutput}"/> instead.
/// </remarks>
/// <example>
/// <code>
...
///     .AddBufferBlock&lt;int&gt;()
///     .AddCustomBlock(new MyAsyncExpander(httpClient))
...
public abstract class AsyncPropagatorManyBlock<TInput, TOutput> : IPropagatorBlock<TInput, TOutput>, IReceivableSourceBlock<TOutput>
{
    ...
    protected AsyncPropagatorManyBlock(ExecutionDataflowBlockOptions options)
    {
        ArgumentNullException.ThrowIfNull(options);
        _innerBlock = new TransformManyBlock<TInput, TOutput>(TransformAsync, options);
    }
    ...
    /// <returns>A task representing the asynchronous transform operation that yields a collection of transformed outputs.</returns>
